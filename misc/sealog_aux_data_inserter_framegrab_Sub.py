            ...
            while True:
                ...
                if event_obj['type'] and event_obj['type'] == 'ping':
                    ...
                    for source in sources:
                        ...
                        dst = os.path.join(dest_dir, f"{source['filename_prefix']}{filename_middle}_{event_obj['message']['event_value'].upper().replace(' ','_')}{source['filename_suffix']}")

                        # ------------ only needed for scp OR local transfers -------------
