...
from python_sealog.cruises import getCruiseByEvent
...
if __name__ == '__main__':
  ...
  parser = argparse.ArgumentParser(description='Retrieve Cruise from Event UID')
  ...
  if not event:
    ...
    cruise = getCruiseByEvent(args.event_uid)
    if cruise != None:
      print(cruise)
    else:
      logger.error("No cruise found for event_uid: " + args.event_uid)