...
describe('Event Templates API', () => {
  ...
  describe('GET /event_templates', () => {
    ...
    it('returns admin_only templates for power_logger (read_admin_templates scope)', async () => {
      const res = await server.inject({
        method: 'GET',
        url: '/sealog-server/api/v1/event_templates',
      ...
      // read_admin_templates scope uses query {} (no filter), so all templates including disabled are returned
