...
const loginSuccessResponse = Joi.object({
  access_token: Joi.string().regex(/^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_.+/=]*$/),
  refresh_token: Joi.string().regex(/^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_.+/=]*$/),
...
const refreshPayload = Joi.object({
  refresh_token: Joi.string().regex(/^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_.+/=]*$/).required()
}).label('refreshPayload');

const refreshSuccessResponse = Joi.object({
  access_token: Joi.string().regex(/^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_.+/=]*$/),
  refresh_token: Joi.string().regex(/^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_.+/=]*$/),
  token_type: Joi.string().valid('bearer')
}).label('refreshSuccessResponse');
...
const userUpdatePayload = Joi.object({
  username: Joi.string().min(1).max(254).optional(),
