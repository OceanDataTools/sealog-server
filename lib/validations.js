...
const cruiseSuccessResponseAccessControl = Joi.object({
  id: Joi.object(),
...
const cruiseSuccessResponseNoAccessControl = cruiseSuccessResponseAccessControl.keys({ cruise_access_list: Joi.forbidden() }).label('cruiseSuccessResponse');
...
const cruiseSuccessResponse = Joi.alternatives().try(
  Joi.string(),
  (useAccessControl) ? cruiseSuccessResponseAccessControl : cruiseSuccessResponseNoAccessControl,
  Joi.array().items((useAccessControl) ? cruiseSuccessResponseAccessControl : cruiseSuccessResponseNoAccessControl)
).label('cruiseSuccessResponse');
...
const loweringSuccessResponseAccessControl = Joi.object({
  id: Joi.object(),
...
const loweringSuccessResponseNoAccessControl = loweringSuccessResponseAccessControl.keys({ lowering_access_list: Joi.forbidden() }).label('loweringSuccessResponse');
...
const loweringSuccessResponse = Joi.alternatives().try(
  Joi.string(),
  (useAccessControl) ? loweringSuccessResponseAccessControl : loweringSuccessResponseNoAccessControl,
  Joi.array().items((useAccessControl) ? loweringSuccessResponseAccessControl : loweringSuccessResponseNoAccessControl)
).label('loweringSuccessResponse');
...
module.exports = {
  ...
  cruiseSuccessResponseNoAccessControl,
  cruiseTag,
  cruiseUpdatePayload,
  ...
  loweringSuccessResponseNoAccessControl,
  loweringTag,
